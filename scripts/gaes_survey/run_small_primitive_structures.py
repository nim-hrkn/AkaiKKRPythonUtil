"""GAES (Method 2, ewidth_init 1.2, [1.0, 2.0]) on examples/small_primitive_structures (akaikkr build, nmag)."""
...
SRC = os.path.join(ROOT, "examples", "small_primitive_structures")
