...
ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))   # AkaiKKRPythonUtil
T = os.path.join(ROOT, "tests", "gaes", "RUN_Hf_stopped", "Al0p25Si0p25Sn0p25Hf0p25_bcc", "key_13145072,ew_000-1.2000,ed_000-1e-04,polytyp_bcc,pm_000-5e-03")   # not in git (tag v1.1.0)
