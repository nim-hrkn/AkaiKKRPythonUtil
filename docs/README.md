...
| [data/hea_XMnFeCo_fcc_orbital_rules_summary.json](data/hea_XMnFeCo_fcc_orbital_rules_summary.json) | データ | 軌道の valence / core 指定（ewidth_tuning_scheme.md §15）を X-Mn-Fe-Co fcc の 17 例に掛けた GAES の結果。図 [data/hea_XMnFeCo_fcc_orbital_rules_dos.png](data/hea_XMnFeCo_fcc_orbital_rules_dos.png)、スクリプト `tests/gaes/tools/plot_orbital_rules.py` |
