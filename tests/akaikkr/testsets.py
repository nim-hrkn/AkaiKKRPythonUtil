...
"""test sets shared by testrun.py (cif backend) and testrun_ase.py (ase backend)."""
...
def make_exe():
    ...
    exe_list += [NiFe_go, NiFe_fsm,NiFe_tc,NiFe_j30,  NiFe_dos, NiFe_spc ]
    exe_list += [FeRh05Pt05_go, FeRh05Pt05_j30, FeRh05Pt05_fsm, FeRh05Pt05_tc, FeRh05Pt05_dos, FeRh05Pt05_spc]
